...
// Local wait utility for standalone example
const wait = (ms: number) => new Promise((resolve) => setTimeout(resolve, ms));

// High impact deletion
export const HighImpactDeletionExample = () => {
...
export const HighImpactDeletionWithConnectedItemsExample = () => {
...
export const HighImpactBatchDeletionExample = () => {
  const batchItems = [
    { id: 1, name: 'Route1_name' },
    { id: 2, name: 'Hpt-392-ser' },
    { id: 3, name: 'Route2_name' },
...
export const MediumImpactDeletionExample = () => {
  const [open, setOpen] = useState(false);
  const [loading, setLoading] = useState(false);
  const [loadingStatus, setLoadingStatus] = useState<
...
// Low impact deletion
export const LowImpactDeletionExample = () => {
  const [open, setOpen] = useState(false);
  const [loading, setLoading] = useState(false);
